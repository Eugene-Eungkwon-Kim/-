...
class Deal(Base):
    ...
    __table_args__ = (
        Index("ix_deal_institution", "financial_institution"),
        Index("ix_deal_vintage", "vintage_year", "vintage_quarter"),
        Index("ix_deal_date", "asset_date"),
    )
...
class Debtor(Base):
    ...
    __table_args__ = (
        Index("ix_debtor_deal", "deal_id"),
        Index("ix_debtor_type", "debtor_type"),
    )
...
class Appraisal(Base):
    ...
    __table_args__ = (
        Index("ix_appraisal_property", "property_id"),
        Index("ix_appraisal_date", "appraisal_date"),
        Index("ix_appraisal_value", "total_value"),
    )
...
class Auction(Base):
    ...
    __table_args__ = (
        Index("ix_auction_property", "property_id"),
        Index("ix_auction_result", "final_result"),
        Index("ix_auction_price", "hammer_price"),
        Index("ix_auction_date", "final_auction_date"),
    )
